...
import 'package:bootbay/src/wigets/BottomNavigationBar/bottom_curved_Painter.dart';
...
class _CustomBottomNavigationBarState extends State<CustomBottomNavigationBar>
        ...
        child: AnimatedContainer(
          ...
          child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                  color: isEnable ? LightColor.grey : Colors.white,
                  boxShadow: <BoxShadow>[
                    BoxShadow(
  ...
  Widget _buildBackground() {
    ...
    return CustomPaint(
      painter: BackgroundCurvePainter(
          ...
          ).transform(_yController.velocity.sign * 0.4 + 0.4),
  ...
  void _handlePressed(int index) {
    ...
    Future.delayed(
      ...
      () {
        _yController.animateTo(.4, duration: Duration(milliseconds: 200));
      },
    );
